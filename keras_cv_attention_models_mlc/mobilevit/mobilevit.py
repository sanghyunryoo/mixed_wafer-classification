...
def MobileViT(
    ...
    nn_logit, out = output_block(nn, output_num_features, activation, num_classes, drop_rate=dropout, classifier_activation=classifier_activation)
    out_soft = functional.concat([out, 1-out], name="soft", axis=1)
