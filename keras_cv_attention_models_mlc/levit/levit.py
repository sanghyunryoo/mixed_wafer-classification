...
def LeViT(
    ...
    if num_classes == 0:
        ...
        out = layers.Dense(num_classes, dtype="float32", activation=classifier_activation, name="cl")(out_z)
        out_soft = functional.concat([out, 1-out], axis=1)
    ...
    model = models.Model(inputs, [out_soft, out], name=model_name)
